...
app.use(
  session({
    ...
    store: MongoStore.create({ mongoUrl: "mongodb+srv://kothavineeth23:kothavineeth23@database.byssanh.mongodb.net/learnFlow?retryWrites=true&w=majority" }), // Updated MongoStore usage
  })
);
...
// app.set("view engine", "ejs");// it works for the rendering of the ejs file
